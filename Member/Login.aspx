<%@ Page Title="Login" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="LibraryManagementSystem.Member.Login" %>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <asp:HyperLink runat="server" NavigateUrl="~/Member/Register" CssClass="btn btn-link">Register as a new user</asp:HyperLink>
                    </div>
                    <div class="form-group">
