<%@ Page Title="Staff Login" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="LibraryManagementSystem.Staff.Login" %>
<%-- Register the CaptchaControl --%>
        ...
        <div class="col-md-6 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <%-- Add the Captcha Control Here --%>
                    <uc:Captcha ID="captchaControl" runat="server" />
                    <%-- Optional: Add a specific literal for CAPTCHA errors --%>
                    <div class="form-group">
                         <asp:Literal runat="server" ID="CaptchaFailureText" />
                    </div>
